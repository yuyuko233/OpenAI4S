...
<!-- Reference: rmarkdown 2.25+, knitr 1.45+, DESeq2 1.42+ | Verify API if version differs -->
...
```{r de-analysis, cache=TRUE, cache.extra=tools::md5sum(params$count_file)}
# cache.extra binds the cache to the data file: editing counts.csv invalidates the
# cache even though the chunk code is unchanged (cache keys on code, not data).
